...
<html>
    <head>
        ...
        <meta name="description" content="CV de KADRI Rayane">
        <link rel="icon" href="favicon.ico"><!-- Ajout du favincon -->
        <meta name="author" content="KADRI Rayane">
        <!-- Bootstrap CSS -->
